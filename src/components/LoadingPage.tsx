...
const LoadingPage: React.FC<ILoadingPage> = (props) => {
  ...
  return (
    <div
      className="w-full h-full flex flex-col justify-center items-center gap-6.5 z-50 smooth-bg-fading fixed"
      style={{ backgroundColor: bgColor }}
    >
      <h2 className="w-[75%] text-white text-[35px] text-center font-semibold smooth-fading">
        {title}
      </h2>
      <div className="w-auto h-auto flex gap-1.5 smooth-fading">
